...
public class MarksList extends ListActivity {
	DBHelper dbHelper;
	TextView numberval;
	TextView marksval;
	Button viewDet;
    ...
    public void function1(final int id){  
        Intent intent = new Intent(getApplicationContext(),ExamsList.class);
    ...
    public void function3(final String id){  
    	...
    	.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
    	    public void onClick(DialogInterface dialog, int which) {			      	
    	    	...
    	    	Toast.makeText(MarksList.this, "deleted",Toast.LENGTH_SHORT).show();
    	    	Intent intent = new Intent(MarksList.this,MarksList.class);
        		startActivity(intent);
    	    }
    	})
    	.show();
          ...
          class MyListAdapter extends SimpleCursorAdapter implements OnClickListener{
           ...
           {       
		    ...
		    String sql = "SELECT DISTINCT class, number FROM student_details ";
